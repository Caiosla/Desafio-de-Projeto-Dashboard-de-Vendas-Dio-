...
1. **Crie um novo arquivo Excel** com 3 abas: `Dados`, `Calculos`, `Dashboard`

2. **Na aba Dados**, crie a tabela com as colunas:
...
5. **Na aba Dashboard**, insira os gráficos:
   - Clique em cada Tabela Dinâmica → **Inserir Gráfico**
   - Mova os gráficos para o Dashboard via **Design → Mover Gráfico**

6. **Adicione os Cards de métricas** com as fórmulas acima nas células desejadas

7. **Formate o Dashboard**: remova linhas de grade, adicione cores e título

8. **Proteja as abas** Calculos e Dashboard via botão direito → **Proteger Planilha**
